...
Perhaps most interestingly, these 'stealth accounts' tend to evade naive LLM as a judge but are found by this method. One regression is that this mildly increases the odds of false positives of humans classified as bots.
